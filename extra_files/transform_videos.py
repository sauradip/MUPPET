...
parser.add_argument('thread_num', type=int, default=64)
parser.add_argument('--video_dir', type=str, default='/datasets01/activityNet200/082217/videos')
parser.add_argument('--output_dir', type=str, default='/checkpoint/frostxu/anet/train_val_112')
