...
with open("./config/anet_2gpu_meta_train.yaml", 'r', encoding='utf-8') as f:
        tmp = f.read()
...
class STALE(nn.Module):
    def __init__(self):
        ...
        self.proj = nn.Sequential(
            nn.Conv1d(2048, 768, kernel_size=3, padding=1),
    ...
    def forward(self, sup_snip, query_snip, sub_cls, sup_proto, sup_trim, mode):
